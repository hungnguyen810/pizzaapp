 ...
 * Generated for Laravel 5.3.9 on 2016-09-22.
 *
...
namespace {
    ...
    class ApiResponse extends \App\Libraries\ApiResponse\ApiResponseFacade{
         ...
         * @static 
         */
        public static function setResponse($message, $errors, $data, $meta){
            return \App\Libraries\ApiResponse\ApiResponse::setResponse($message, $errors, $data, $meta);
        }
         ...
         * @static 
         */
        public static function responseJson($message, $errors = array(), $data = array(), $meta = array(), $code = 200){
            return \App\Libraries\ApiResponse\ApiResponse::responseJson($message, $errors, $data, $meta, $code);
        }
         ...
         * @static 
         */
        public static function success($message, $data, $meta = array()){
            return \App\Libraries\ApiResponse\ApiResponse::success($message, $data, $meta);
        }
         ...
         * @static 
         */
        public static function error($message, $errors = array(), $code = 400){
            return \App\Libraries\ApiResponse\ApiResponse::error($message, $errors, $code);
        }
         ...
         * @static 
         */
        public static function errorValidation($errors, $message = false){
            return \App\Libraries\ApiResponse\ApiResponse::errorValidation($errors, $message);
        }
         ...
         * @static 
         */
        public static function errorInternal($message, $code = 500){
            return \App\Libraries\ApiResponse\ApiResponse::errorInternal($message, $code);
        }
